            ...
            return (
              ...
              >
                <div style={{ padding: "2.5rem 2.5rem 1.5rem", display: "flex", alignItems: "center", gap: "1.2rem" }}>
                  <div style={{ width: "4.4rem", height: "4.4rem", borderRadius: "0.4rem", background: `${accentColor}22`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <Icon style={{ width: "2.2rem", height: "2.2rem", color: accentColor }} />
                  </div>
                  <h3 style={{ fontSize: "1.8rem", fontWeight: 600, color: "#fff", lineHeight: 1.3 }}>{pillar.title}</h3>
                </div>
